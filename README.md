...
🎯 **[View Senior DevOps Engineer Roadmap (5+ Years Experience)](./ROADMAP.md)**
...
### Module 03: Docker & Docker Compose Engineering (5+ YOE Scope)
- 🐳 **[View Docker & Docker Compose Master Roadmap](./03-Docker/docker-and-docker-compose.md)** (30 Production Topics & Scenarios)

---

### Module 07: Infrastructure as Code (IaC) with Terraform (5+ YOE Scope)
- 🏗️ **[View Terraform Master Roadmap](./07-Terraform/terraform.md)** (36 Production Topics & Architecture Scenarios)
